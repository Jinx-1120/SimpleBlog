    ...
    return !matchedSlug
      ...
      : matchedParam
        ...
        .then(param => {
          ...
          if (paramId) {
            const querysOptions = Object.assign(querys, { [paramField]: paramId });
            Reflect.deleteProperty(querysOptions, matchedField);
            return this.articleService.getList(querysOptions, options);
          } else {
